...
public class Vyrazy {
    ...
    public static enum TokenType {
        NUMBER, VARIABLE, ASSIGNMENT, SUM, PRODUCT, EOF, LEFTBRACKET, RIGHTBRACKET
    }
    ...
    public static class Token {
        ...
        public static Token makeLeftBracket(String leftBracket) {
        	return new Token(TokenType.LEFTBRACKET, 0, "");
        }
        public static Token makeRightBracket(String rightBracket) {
        	return new Token(TokenType.RIGHTBRACKET, 0, "");
        }
        ...
        private void lexIt(String input) {
            ...
            for (char c : input.toCharArray()) {
                ...
                if (c == '+') {
                    ...
                    tokens.add(Token.makeVariable(String.format("%c", c)));
                } else if (c == '#') {
                	break;
                } else if (c == '(') {
                	tokens.add(Token.makeLeftBracket(String.format("%c", c)));
                } else if (c == ')') {
                	tokens.add(Token.makeRightBracket(String.format("%c", c)));
                } else {
    ...
    public static class Parser {
        ...
        private boolean nextTypesAre(TokenType... types) {
        ...
        private Node number() {
            ...
            } else if (nextTypesAre(TokenType.LEFTBRACKET)) {
            	lexer.next();
            	Node n = expression();
            	if (lexer.next().type != TokenType.RIGHTBRACKET) {
            		String messege = String.format("Expected %s, got %S.", TokenType.RIGHTBRACKET, lexer.peek());
    ...
    public static void main(String[] args) {
        ...
        while (input.hasNextLine()) {
            ...
            ast.tree("");
            int value = ast.compute();
            vars.set("_", value);
            System.out.printf("'%s' => '%s' = %d\n", line, ast.format(), value);
        }
        input.close();
    }
}